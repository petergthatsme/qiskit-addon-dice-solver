...
def solve_hci(
    ...
    *,
    ...
    Args:
        ...
        mpi_runner: program to execute mpi-capable code; some systems use wrappers for standard 'mpirun'
...
def _call_dice(dice_dir: Path, mpirun_options: Sequence[str] | str | None, mpi_runner: str = "mpirun") -> None:
    ...
    if mpirun_options:
        ...
        dice_call = [mpi_runner] + list(mpirun_options) + [dice_path]
    else:
        dice_call = [mpi_runner, dice_path]
